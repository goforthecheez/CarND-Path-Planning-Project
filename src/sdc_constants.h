...
// How much steering history to keep.
const double STEERING_HISTORY_LENGTH = 5;
// Scaling factor to speed correction around curves.
const double STEERING_SPEED_SCALE = 3.0;
// Speed above which to apply the steering correction.
const double THRESHOLD_SPEED_FOR_STEERING_CORRECTION = 30.0;  //mph
// Standard deviations of s and d for candidate target generation.
